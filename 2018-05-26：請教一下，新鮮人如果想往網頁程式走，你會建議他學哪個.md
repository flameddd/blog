...
　　此文有貼在 FB 相關技術群中，相關網友有對此議題做討論。建議有任何疑問時，去此討論串發問，讓多點人來回答你的問題。
 - [FB javascript.tw](https://www.facebook.com/groups/javascript.tw/permalink/1383234408444560/)
 - [FB f2e.tw](https://www.facebook.com/groups/f2e.tw/permalink/1679529185417773/)
...
> 2. 選定一個 framework，去照著官網基礎教學做一次。
    ...
    <p align="center>
    <img src="assets/img/Iron Man run before walk.jpg">
    </p>
    [圖片來源]()

  此為學習方式、方向議題，不過本文其中一個關鍵字為「學習路徑」，加上這麼多人提議「先碰」「html, css, js」，所以各位可以認真考量此建議。當「框架」真的讓你卡死時，先回來先碰「html, css, js」。碰到什麼程度？一樣是刻一個頁面所用到的方法、屬性你大多都能認識的程度。
