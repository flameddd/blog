...
(Update: 這篇筆記是 2018 年紀錄的，已經過去蠻久了。有些主題，在實作方面，我建議可以參考 [fastify](https://fastify.dev/docs/latest/) 怎麼做，Express 已經太老舊了)
...
建議使用
- bcrypt: [https://www.npmjs.com/package/bcrypt](https://www.npmjs.com/package/bcrypt)，而不是 native crypto
